...
# Load known faces
sumiths_image = face_recognition.load_image_file("facerecognizer/faces/sumith.jpg")
sumith_encoding = face_recognition.face_encodings(sumiths_image)[0]

rohans_image = face_recognition.load_image_file("facerecognizer/faces/rohan.jpg")
